(function() {
    ...
    function initHeader() {
        ...
        for(var i in points) {
            var c = new Circle(points[i], 2+Math.random()*2, 'rgba(11,176,194,0.588)');
            points[i].circle = c;
        }
    }
    ...
    for (var i in p.closest) {
        ...
        ctx.strokeStyle = 'rgba(11, 176, 194,' + p.active + ')'; // Updated color
        ctx.stroke();
    }
}
    ...
    ctx.fillStyle = 'rgba(11, 176, 194,' + _this.active + ')'; // Updated color
    ctx.fill();
